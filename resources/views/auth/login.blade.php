              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Acesse sua conta e vá a compras!</h1>
                  </div>
                  <form method="POST" action="{{ route('login') }}">
                    @csrf>
                    <div class="form-group">
                      <input name="login" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                      @error('email')
                    ...
                    @endif
                    <hr>
                      <!-- <button disabled class="btn btn-google btn-user btn-block">
                  ...
                  <hr>
                  <div class="text-center">
                      <a class="btn btn-primary btn-user btn-block" href="{{route('register')}}">Crie sua conta</a>
                  </div>
                </div>
              </div>
            </div>
